...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:22C55E,45:06B6D4,100:111827&height=220&section=header&text=Flow%20Viewer&fontSize=54&fontColor=ffffff&fontAlignY=38&desc=See%20every%20OpenLeash%20agent%20event%20from%20ingress%20to%20decision.&descSize=18&descAlignY=58" width="100%" />

<p>
  <a href="https://openleash.com"><img src="https://img.shields.io/badge/OpenLeash-openleash.com-06B6D4?style=for-the-badge&logo=googlechrome&logoColor=white" /></a>
...
`flow-viewer` is OpenLeash's local pipeline observability app. It tails the
...
The viewer displays what OpenLeash received; it does not invent a second
...
Requirements: Node.js 20 or newer and an OpenLeash NDJSON pipeline trace.
...
From the OpenLeash workspace, the recommended path is:
...
- The app never uploads traces or calls OpenLeash Cloud.
